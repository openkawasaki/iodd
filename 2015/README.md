...
##### <u>(去年) インターナショナル・オープン・データ・デイ 2014</u>
...
テーマ：誰でも気軽に参加して楽しめる  
イベント：川崎大師周辺のマッピングパーティとゴミ拾いします。  

イベントは、２会場同時で開催し下記の作業をします。

* 川崎会場は川崎大師周辺で情報収集とゴミ拾い
* 新丸子会場は地図のデータ作成

地図は「みんなで作る地図」または「地図のWikipedia」とも言われているOpenStreetMap <http://www.openstreetmap.org/>を利用して作成します。
OpenStreetMapは誰でも無料で使えるもので地図のオープンデータとも言われています。
...
* 川崎会場 (情報収集チーム)
  ...
  - ルートやグループを分けて作業
	* エリアにチームを分けてマッピング
	* [ルート案](http://fieldpapers.org/atlas.php?id=z82rg2t8#16/35.5342/139.7292) 
* 新丸子会場 (OSMデータ作成チーム)
  - 作業する担当にチーム分けをします 
  - OSMデータ(地図データ)を作成
...
* 川崎会場 (情報収集チーム)
  - 実費(会場代)を参加者で均等負担 (数百円〜100円)を予定
* 新丸子会場 (OSMデータ作成チーム)
  - コワーキングスペース利用料金 (1,000円〜1,300円)を予定

### <u>参加条件</u>

どなたでも参加可能です。年齢制限や職種などは関係ありませんが
OSMデータ作成チームはパソコンが使えるとよろしいかと思います
